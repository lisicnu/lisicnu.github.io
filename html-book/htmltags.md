...
## 本文主要内容
 ...
 - 列表标签：[`<ul>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/ul)、[`<ol>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/ol)、[`<dl>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dl)
 - 表格标签：[`<table>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/table)
 - 框架标签及内嵌框架[`<iframe>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/iframe)
 - 表单标签：[`<form>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form)
 - 多媒体标签： [`<object>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/object)
 - ~~滚动字幕标签(已过时)：[`<marquee>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/marquee)~~
...
![20211031_1617](/images/20211031_1617.png)

场景2、li 里面放置的内容可能很多：

![](/images/20170704_1719.png)
...
![](/images/htmltag_13.png)

效果举例：（纵向合并）

![](/images/htmltag_15.png)
...
![](/images/htmltag_26.png)

上图中，如果删掉页面right.html，显示效果如下：

![](/images/htmltag_27.png)
...
![](/images/htmltag_28.png)

效果：

![](/images/htmltag_gif3.gif)
...
![](/images/htmltag_35.png)

### `<select>`

下拉列表标签，`<select>`标签里面的每一项用`<option>`表示。select就是“选择”，option“选项”。
...
使用频次低， 比如，我们在注册一个网站的信息的时候，有一部分是必填信息，有一部分是选填信息，这个时候可以利用表单的语义化。 

[更多资料](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/fieldset)
...
**前提：**
多媒体包含：音频、视频、Flash、文档等。通常.wmv、.dat、.mob、.rmvb等视频格式，在网页上不能直接播放，需要安装第三方的插件才可以播放。
...
![](/images/htmltag_38.png)


### `<video>`

在HTML5中新增, [详细资料](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video)

### `<object>`

播放多媒体文件（音频、视频等）。[详细资料](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/object)

**属性：**
 - ~~`classid`~~：插件的ID号，一般存在于注册表中。
