...
- 能够插入的图片类型是：jpg(jpeg)、gif、png、bmp等 [可以自己尝试]。
...
![Paste_Image.png](/images/20151001_19.jpg)

相对路径的面试题。现有如下文件层级图：

![](/images/20170630_1133.png)
...
```html
<img src="https://www.google.co.jp/url?sa=i&url=https%3A%2F%2Fwww.sion-hikari.com%2Fitem%2Fsu0053%2F&psig=AOvVaw037X-f1KY2PEMO-o9aEpM-&ust=1666078797847000&source=images&cd=vfe&ved=0CA0QjRxqFwoTCNi7rKrh5voCFQAAAAAdAAAAABAE">
...
- 目前的实际方案中，绝大部分网页内容和图片都是分开在不同的服务器上（得意于云服务器和CDN的发展），所以绝对路径占了大部分。
...
![Paste_Image.png](/images/img-21.png)
...
![Paste_Image.png](/images/img-20.png)
