...
![Paste_Image.png](../images/link-11.png)

错误的效果如下：

![Paste_Image.png](../images/link-12.png)

其实我们只要记住前三个符号就行了，其他的在需要的时候查一下就行了。而且，`EditPlus`中是可以直接点击这些符号进行选择的： (Editplus 只是工具，其他软件也能找到)

![Paste_Image.png](../images/link-13.png)
...
![Paste_Image.png](../images/link-15.png)
...
![Paste_Image.png](../images/link-14.png)
...
![Paste_Image.png](../images/link-10.png)
...
![Paste_Image.png](../images/link-16.png)
...
![Paste_Image.png](../images/link-17.png)
...
![Paste_Image.png](../images/link-18.png)
...
```html
<a href="mailto:lisicnu@gmai.com">点击进入我的邮箱</a>
```
