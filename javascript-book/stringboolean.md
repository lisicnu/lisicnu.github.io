...
var str3 = 'javascript';
var str4 = 'keep foolish keep hungry.';
...
var str3 = 'Ethan' + true;
var str4 = 'Ethan' + null;
var str5 = 'Ethan' + undefined;

var obj = { name: 'Ethan', age: 28 };
var str6 = 'Ethan' + obj;
...
比如上面的代码，当重新给变量 str 赋值时，常量`hello`不会被修改，依然保存在内存中；str 会改为指向`Ethan`。
...
console.log(`www.${getName()}.com`); // 打印结果：www.Ethan.com
```

### 模板字符串支持嵌套使用

```js
const nameList = ['Ethan', '许嵩', '解忧少帅'];
